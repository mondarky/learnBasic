...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post tutorials_url, params: { tutorial: { email: @tutorial.email, first_name: @tutorial.first_name, last_name: @tutorial.last_name, phone: @tutorial.phone } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { email: @tutorial.email, first_name: @tutorial.first_name, last_name: @tutorial.last_name, phone: @tutorial.phone } }
